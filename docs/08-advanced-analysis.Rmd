...
Each module includes dedicated visualization functions and integrates with the standard UKBAnalytica workflow. Machine learning now has a separate chapter because the recommended API is a full frozen-test workflow rather than a single model-fitting helper.
