...
This chapter covers the advanced statistical analysis modules in **UKBAnalytica_v2**, including subgroup analysis, propensity score methods, mediation analysis, and multiple imputation pooling.
...
### Visualization {#mediation-visualization}
...
### Visualization {#mi-visualization}
...
This chapter covered four advanced statistical modules:
...
Each module includes dedicated visualization functions and integrates with the standard UKBAnalytica_v2 workflow. Machine learning now has a separate chapter because the recommended API is a full frozen-test workflow rather than a single model-fitting helper.
