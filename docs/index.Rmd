...
description: |
  ...
  disease phenotyping, survival analysis, multiple imputation, and proteomics
  enrichment analysis.
link-citations: yes
...
9. **Proteomics enrichment** -- Convert RAP-exported Olink protein names to gene symbols and run GO/KEGG ORA.
