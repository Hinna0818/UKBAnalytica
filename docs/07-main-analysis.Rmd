...
This chapter demonstrates how to perform statistical analyses using **UKBAnalytica_v2**, including pre-analysis correlation checks and three types of regression models: linear regression, logistic regression, and Cox proportional hazards regression.
...
**UKBAnalytica_v2** provides three regression functions with a unified interface for testing multiple variables:
