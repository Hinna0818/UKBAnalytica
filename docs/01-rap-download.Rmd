...
If the UKBAnalytica_v2 release is already installed in the RAP environment:
...
Use `variables` for exact columns defined by UKBAnalytica_v2. Use `field_id` when
...
Then continue with UKBAnalytica_v2 preprocessing:
